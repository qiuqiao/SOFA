...
def plot_for_valid(
    ...
    ax2.imshow(alignment_spec.T, origin="lower", aspect="auto", interpolation="nearest")

    if ph_seq is not None and ph_intervals is not None:
