...
1. Download the model files. You can find the trained models in the [release section of this repository](https://github.com/qiuqiao/SOFA/releases), or you can find community-shared model download links in the [discussion section](https://github.com/qiuqiao/SOFA/discussions/categories/pretrained-model-sharing), with the files having a `.ckpt` extension.
